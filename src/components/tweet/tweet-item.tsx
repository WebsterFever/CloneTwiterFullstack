...
import { faHeart , faHeart as faHeartFilled } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import Link from "next/link";
import { useState } from "react";
import { formatRelativeTime } from "@/utils/format-relatives";
           ...
           <div className="flex-1">
               ...
               {tweet.image && 
                ...
                <div className="flex mt-6 text-gray-500">
                    ...
                    <div className="flex-1">
                          <div onClick={handleLinkeButton} className={`inline-flex items-center gap-2 cursor-pointer ${liked && ' text-red-400 '}`}>
